...
update [dbo].[tb_Validation] set validation = '\w+([-+.'']\\w+)*@\w+([-.]\\w+)*\.\w+([-.]\w+)*' where id=3
...
---------------------FIRST TABLE------------------------------------------------------------------
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (1,'RAFTID','Raftid',NULL,1,1,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (1,'TokenUsed','TokenUsed',NULL,3,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (1,'Token','Token',NULL,1,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (1,'ResponseInfo','ResponseInfo',NULL,1,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (1,'Phone','Phone',1,1,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (1,'Email','Email',3,1,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (1,'Identification','Identification',2,1,0,GETDATE(),1)
---------------------SECUND TABLE---------------------------------------------
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (2,'idData','idData',NULL,4,1,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (2,'date','date',NULL,4,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (2,'makeup','makeup',NULL,2,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (2,'type','type',NULL,1,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (2,'wager Type','wagerType',NULL,1,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (2,'league','league',NULL,1,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (2,'line Type','lineType',NULL,1,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (2,'description','description',NULL,1,0,GETDATE(),1)

---------------------SHARE POINT LIST-------------------
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (3,'RAFTID','Title',NULL,1,1,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (3,'TokenUsed','TokenUsed',NULL,3,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (3,'Token','Token',NULL,1,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (3,'ResponseInfo','ResponseInfo',NULL,1,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (3,'Phone','Phone',1,1,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (3,'Email','Email',3,1,0,GETDATE(),1)
INSERT INTO [dbo].[tb_ColumnBySource] VALUES (3,'Identification','Identification',2,1,0,GETDATE(),1)
...
GO
CREATE TABLE select * from   [dbo].[tb_Document]
(
    [id] INT IDENTITY NOT NULL,
...
WHERE C.is_identity = 1 and T.name='tb_Document'
ORDER BY T.name 
